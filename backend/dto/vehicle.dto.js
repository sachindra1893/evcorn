...
function toVehicleDTO(doc) {
  ...
  return {
    ...
    bhp: validVal(obj.performance?.maxPowerBHP ? `${obj.performance.maxPowerBHP} bhp` : null, obj.bhp || 'N/A'),
    torque: validVal(obj.performance?.maxTorqueNM ? `${obj.performance.maxTorqueNM} Nm` : null, obj.torque || 'N/A'),
    topSpeed: validVal(obj.performance?.topSpeedKMH ? `${obj.performance.topSpeedKMH} km/h` : null, obj.topSpeed || 'N/A'),
    acceleration: validVal(obj.performance?.acceleration0to40Sec ? `${obj.performance.acceleration0to40Sec}s (0-40)` : (obj.performance?.acceleration0to100Sec ? `${obj.performance.acceleration0to100Sec}s` : null), obj.acceleration || 'N/A'),
    bootSpace: validVal(obj.dimensionsObj?.bootSpaceLiters ? `${obj.dimensionsObj.bootSpaceLiters} L` : null, obj.bootSpace || 'N/A'),
    wheelSize: validVal(obj.dimensionsObj?.wheelSize, obj.wheelSize || 'N/A'),
